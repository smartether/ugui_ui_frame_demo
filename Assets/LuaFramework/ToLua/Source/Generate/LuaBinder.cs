...
public static class LuaBinder
{
	public static void Bind(LuaState L)
	{
		...
		L.RegFunction("Action_UnityEngine_GameObject_objects", System_Action_UnityEngine_GameObject_objects);
		L.EndModule();
		L.EndModule();
		L.BeginPreLoad();
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int System_Action_UnityEngine_GameObject_objects(IntPtr L)
	{
		try
		{
			int count = LuaDLL.lua_gettop(L);
